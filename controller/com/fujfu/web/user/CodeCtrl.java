...
public class CodeCtrl {
	private static final Logger log = Logger.getLogger(CodeCtrl.class);
    ...
    @ResponseBody
    public Object checkcode(HttpServletRequest req, String picCode) {
    	
    	log.info("picCode = " + picCode);
    	
    	Map<String, String> map = new HashMap<String,String>();
    	if(StringUtil.isEmpty(picCode)){
    		map.put("flag", "0");
    		return map;
    	}
