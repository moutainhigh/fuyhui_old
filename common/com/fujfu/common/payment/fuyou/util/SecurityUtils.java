...
import com.fujfu.common.util.PropertiesUtil;
...
public class SecurityUtils {
	...
	private static String privateKeyPath="com/fujfu/common/payment/fuyou/onlinekey/prkey.key";
//	private static String privateKeyPath="com/fujfu/common/payment/fuyou/key/prkey.key";
	
	/**
	 * 公钥文件路径 如：D:/rsa/pbkey.key
	 */
	//private static String publicKeyPath="D:/pbkey.key";
	private static String publicKeyPath="com/fujfu/common/payment/fuyou/onlinekey/pbkey.key";
//	private static String publicKeyPath="com/fujfu/common/payment/fuyou/key/pbkey.key";
	...
	public static void initPrivateKey(){
		try {
				if(privateKey==null){
					privateKey = getPrivateKey(PropertiesUtil.getFyKeyPath(privateKeyPath));
				}
		} catch (Exception e) {
	...
	public static void initPublicKey(){
		try {
			if(publicKey==null){
				publicKey = getPublicKey(PropertiesUtil.getFyKeyPath(publicKeyPath));
			}
		} catch (Exception e) {
			System.out.println("SecurityUtils初始化失败" + e.getMessage());
			e.printStackTrace();
