 ...
 */
public class HtmlBuilder extends AbstractStringBuilder {
  /**
  ...
  public HtmlBuilder onmousedown(String onmousedown) {
    if(StringUtils.isNotBlank(onmousedown)) {
      write(" onmousedown=\"").write(onmousedown).write("\" ");
    }
  ...
  /**
   * <p>The onkeydown attribute [onkeydown=].</p>
   */
  public HtmlBuilder onkeydown(String onkeydown) {
    if(StringUtils.isNotBlank(onkeydown)) {
      write(" onkeydown=\"").write(onkeydown).write("\" ");
    }
   ...
   */
  public HtmlBuilder appendString(String text) {
    append(text);
