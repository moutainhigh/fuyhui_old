;(function($){
	...
	var pcData = {'provinces':[]},//省市数据
		caData = {'cities':[]};//市区数据
	var defaultStr = '<a href="javascript:void(0);" val="-1">省</a>',
	 	defaultStr02 = '<a href="javascript:void(0);" val="-1">市</a>',
		defaultStr03 = '<a href="javascript:void(0);" val="-1">县/区</a>',
		defaultId = -1,
		defaultName = '省',
		defaultName02 = '市',
		defaultName03 = '县/区';
	...
	function showCity(obj, cities, selectCId){
		var tempStr = defaultStr02;
		var tempId = defaultId;
		var tempName = defaultName02;
	...
	function showArea(obj, areas, selectAId){
		var tempStr = defaultStr03;
		var tempId = defaultId;
		var tempName = defaultName03
