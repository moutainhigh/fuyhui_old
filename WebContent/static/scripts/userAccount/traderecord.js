            ...
            success:function(json){
                ...
                for(var i=0,l=json.content.length;i<l;i++){
                    ...
                    if(trade_type==4100){
                        ...
                        trade_txt = '红包收入';
                    }else if(trade_type==1033){
                        trade_txt = '邀请奖励';
                    }else if(trade_type==4206){
                        trade_txt = '提前回款成功';
                    }
                    // 交易编号
                    ...
                    // 交易金额
                    var trade_amout = '';
                    if(trade_type==4100 || trade_type == 4203 || trade_type == 4301 || trade_type == 3001 || trade_type == 3002 || trade_type == 1032 || trade_type==1033 || trade_type==4206){
                        trade_amout = '<p class="tra_tixian" style="width:195px;">+'+json.content[i].money+'</p>';
                    }else if(trade_type==4204 || trade_type==4302 || trade_type==4303 || trade_type==4102 || trade_type==4103 || trade_type==4101 || trade_type==4202){
                    ...
                    success:function(json){
                        ...
                        for(var i=0,l=json.content.length;i<l;i++){
                            ...
                            for(var key in json.content[i]){
                                // str = '<div class="each_tab_tr"><p class="tra_number" style="width:195px;">'+trade_number+
                                //       '</p>'+trade_amout+'<p class="tra_avail_money" style="width:195px;">'+accounts+'</p><p class="tra_type" style="width:195px;">'+
                                //       trade_txt+'</p><p class="tra_time" style="width:195px;">'+trade_time+'</p><p style="width:195px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">'+json.content[i].memo+'<div class="clear"></div></div>';
