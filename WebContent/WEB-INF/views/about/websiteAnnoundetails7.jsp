...
<div class="content aboutUs">
    ...
    <div class="concen concenA" style="margin-top:-30px;height:590px !important;">
    <div class="website-smacen">
    <p class="p-tit" style="text-align:center;">金猪002号产品暂停发布公告 <label class="fr back" onclick="window.history.go(-1);" style="cursor:pointer;">返回></label></p>
     <div class="desc-1 det04_title">
        尊敬的用户：
    </div>
    <div class="det04_txt_box">
        <p>为了提供您更优质、稳健的服务，富元汇将对与合作方的对接系统进行进一步维护和优化，同时将暂停发布金猪002号产品。</p>
        <p> 给您带来不便，敬请谅解！富元汇将尽快推出更多优质产品，您可通过富元汇官网的网站公告进行了解。</p>
    </div>
    ...
    <div style="text-align:right;">2017年6月27日</div>
