...
<div class="content aboutUs">
    ...
    <p class="p-tit" style="text-align:center;">金猪001号产品发布公告 <label class="fr back" onclick="window.history.go(-1);" style="cursor:pointer;">返回></label></p>
     <div class="desc-1 det04_title">
        产品简介
    </div>
    <div class="det04_txt_box">
        <p>深圳国投商业保理有限公司将其持有的主板上市公司的应收账款收益权通过金融资产交易所挂牌转让，并承诺到期全额回购。</p>
    </div>
     <div class="desc-1 det04_title">
        产品详情
    </div>
    <div class="det04_txt_box">
        ...
        <p>2、预期年化收益： 8%</p>
        <p> 3、预期产品期限：90天</p>
        <p>4、回款方式：到期一次性还本付息</p>
        <p>5、认购起点金额：3,000.00-5,000.00元人民币</p>
    </div>
    <div class="desc-1 det04_title">
    回款来源
    </div>
     <div class="det04_txt_box">
        ...
        <p>2、主板上市公司开立的商业承兑汇票到期承兑，票面金额1750万。</p>
    </div> 
    ...
    增信措施
     ...
     <div class="det04_txt_box">
        ...
        <p>4、深圳国投商业保理有限公司将其持有的主板上市公司开出的超额商业承兑汇票提供质押担保。</p>
    </div>  
