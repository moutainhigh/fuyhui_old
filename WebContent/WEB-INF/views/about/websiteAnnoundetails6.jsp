...
<div class="content aboutUs">
    ...
    <p class="p-tit" style="text-align:center;">金猪002号产品发布公告 <label class="fr back" onclick="window.history.go(-1);" style="cursor:pointer;">返回></label></p>
    ...
    <div class="det04_txt_box">
        <p> 该产品拟于2017年6月26日（下周一）上午10:00开始发布，如有调整，将另行通知。</p>
