    <%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <div class="concen concenA" style="margin-top:-30px;">
        <div class="website-smacen mediad-smacen">
        <p class="p-tit" style="text-align:center;">富士康旗下互联网金融服务平台富元汇正式上线<label class="fr back" onclick="window.history.go(-1);" style="cursor:pointer;">返回></label></p>
        <p style="margin:10px 0;font-size:12px;text-align:center;">来源：中华财经网</p>
        
        <div class="mediad-container">
        <div class="media-dcon" style="text-indent:2em;line-height:25px;text-align:justify;">
        世界百强企业鸿海富士康科技集团旗下金融品牌富金富打造的互联网金融服务平台富元汇(http://www.fuyhui.com/)于2017年6月正式上线，致力于为用户提供稳健、诚信、高效的金融产品交易等互联网信息技术服务。
        </div>
        <h3 style="font-size:16px;">世界百强企业背景强实力</h3>
        <div class="media-dcon" style="text-indent:2em;margin:0 !important;line-height:25px;">
        富元汇是由富士康科技集团旗下全资子公司深圳市富之富信息技术有限公司运营的理财投资平台，注册资本人民币一亿元。这是富士康进军互联网金融的又一重要成就，富元汇携手行业内具备多年资产管理服务和风险控制经验人才共同为投资用户提供安全透明、稳健高效的互联网金融产品，满足用户多样化、个性化的理财需求，实现更优化的理财配置方案。资金有保障、投资更放心。

        </div>
        <div class="media-dcon" style="text-indent:2em;margin-top:0 !important;line-height:25px;">
        为保证用户的资金安全，富元汇与富友集团联手资金存管，用户交易资金全程由富友支付存管，实现平台投资人交易账户的封闭监管，在没有得到用户的充分授权的情况下，平台不能触碰用户资金，确保交易资金安全。同时携手青岛国富金融资产交易中心、广东银华律师事务所、贤方律师事务所、金诚同达律师事务所等多家建立战略合作伙伴关系，确保平台合规经营、稳健发展。
        </div>
        <h3 style="font-size:16px;">稳健收益，财富增值</h3>
        <div class="media-dcon" style="text-indent:2em;margin:0 !important;line-height:25px;">
        富元汇平台上线初期将推出“金猪系列”、“金桔系列”等多种金融产品，预期产品期限为1-6个月，预期年化收益为6%-10%，且有相应的增信措施以保障用户的资金安全。未来还将为用户提供包括保险和基金等多元化的金融产品互联网交易信息技术服务。
        </div>
        <div class="media-dcon" style="text-indent:2em;margin-top:0 !important;line-height:25px;">
        富元汇力求打造一个安全透明的互联网金融服务平台，进一步实现用户个性化、多元化、智能化的金融需求。
        </div>
        <div class="media-dcon" style="text-indent:2em;line-height:25px;">
        ...
        <div class="media-dcon">
            <a href="http://www.cjwcn.cn/hccnews/2017/3117238705.html" style="color:#666;font-size:12px;">链接：http://www.cjwcn.cn/hccnews/2017/3117238705.html</a>
        </div>
        </div>
        </div>
        </div>
