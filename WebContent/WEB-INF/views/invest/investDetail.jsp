...
<head lang="zh-cn">
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/static/styles/invest/inDetail.css">
	...
	<script type="text/javascript" src='${pageContext.request.contextPath }/static/scripts/invest/inDetail.js'></script>
	<script type="text/javascript" src='${pageContext.request.contextPath }/static/scripts/invest/investWindow.js'></script>
	<style type="text/css">
		.investagreement
		{
			color: #303642;
				...
				<c:choose>
					...
					<c:when test="${investment.status == 8 && investment.isLoans == 0}">
						...
						<div class="inDetail_also">
							...
							<div class="indet_btnBox">
								<div class="fl inDetail_btn" onclick="window.location.href=getContextPaths()+'/enterInvest'" style="margin:40px 0 0 48px !important;">认购其它产品</div>
								<!-- <p class="fuyuanhuiImg"></p> -->
							</div>
					...
					<c:otherwise>
						...
						<div class="inDetail_complete">
							...
							<div class="indet_btnBox">
								<div class="fl inDetail_btn" style="margin:40px 0 0 48px !important;" onclick="window.location.href=getContextPaths()+'/enterInvest'" style="margin:40px 0 0 48px !important;">认购其它产品</div>
		...
		<div class="indet_bot_1000">
			<div class="indet_bot_contentBox">
				...
				<div class="indet_project_infosBox">
					...
					<p class="risk_toops" style="margin-left:29px;font-size:14px;color:#474e5d;line-height:28px;">尊敬的会员： 您所购买的金猪系列产品虽然由增信机构提供了增信措施，但您仍有可能面临信用风险以及增信机构能力下降的风险等，您可能面临本金及收益的损失。 富元汇别提示您，请您根据自身的理财规划及风险承受能力进行决策。</p>
				...
				<div class="indet_plan_infoBox" style="display:none;">
					<div class="indet_refund_box">
						<div class="fl relady_refund">已兑付金额：<span class='re_refund'>0.00</span>元</div>
						<div class="fl no_refund">待兑付金额：<span class='dai_refund'>0.00</span>元</div>
						<div class="clear"></div>
					</div>
					<div class="refund_titleBox">
						<ul class="refund_list">
							<li class="refund_item01">期数</li>
							<li class="refund_item02">兑付日期</li>
							<li class="refund_item03">兑付本金</li>
							<li class="refund_item04">兑付收益</li>
				...
				<div class="question_box_infos" style="display:none;">
					...
					<div class="que_div">
						...
						<p class="que_tement">每个产品的认购人数不能超过200人；</p>
						<p class="que_tement">认购者的年龄必须大于18周岁；</p>
						<p class="que_tement">认购者的风险等级满足产品规定的要求。</p>
					</div>
					<div class="que_div">
						<p class="que_txtTitle">4、如何购买交易所产品？</p>
						<p class="que_tement">
							您只能认购与您的风险等级对应的交易所产品，认购交易所产品需要投资人在相应交易所开户并注册成为其会员，所以认购前您需要对交易所的开户协议进行确认，之后绑定银行卡进行支付。产品<span style='font-family:"宋体"'>募</span>集成功后，交易所将对您的认购份额进行登记。
						</p>
					</div>
					<div class="que_div">
						<p class="que_txtTitle">5、交易所产品在到期前可以提前赎回么？</p>
						<p class="que_tement">
							在<span style='font-family:"宋体"'>募</span>集期内，即产品成立前，您的认购资金将被冻结，不能取消。如果产品<span style='font-family:"宋体"'>募</span>集失败，则申购资金会退回至您的账户内。当产品<span style='font-family:"宋体"'>募</span>集成功后，您不能提前赎回，只能等到产品到期。
						</p>
					</div>
					<div class="que_div">
	...
	<script type="text/javascript">
       ...
       $(function(){
			...
			$('.no_investagreement').click(function(){
				var contractHref =globalUrl+'/pdf/${investment.productUrl}/${investment.orderNumber}02.pdf';
                $.ajax({
                    type:'post',
            ...
            //var contractHref02 ='/fyh/pdf/${investment.productUrl}/${investment.orderNumber}02.pdf';
            //$('.real_ind_btn').attr('conhref',contractHref02);
           // alert( $('.real_ind_btn').attr('conhref'));
		...
		// function hrefFunction(obj){
			// 需要带过去的合同url
		// 	var contractHref =getContextPaths() + '/fyh/pdf/${investment.productUrl}/${investment.orderNumber}02.pdf';
