...
<body>
	...
	<div style="background: #fafafa; padding: 10px;">
		<form id="fullLoanApplyListForm" action="" class="form-inline definewidth m20">
			<table class="table table-bordered table-hover definewidth m10">
				...
				<c:forEach items="${fullLenderList.items }" var="loan">
					<tr class="info" ondblclick='window.location.href="${pageContext.request.contextPath }/loan/loanApply/enterRepayConfirm?id=${loan.id }"'>
						<td>${loan.loanName }</td>
				...
				<tr>
				<td colspan=9><page:Pager formName="fullLoanApplyListForm"
						pageAttributeName="fullLenderList" styleClass="textfield"
