...
<body>
	...
	<div style="background: #fafafa; padding: 10px;">
		<form id="loanApplySReviewListForm" action="" class="form-inline definewidth m20">
			<table class="table table-bordered table-hover definewidth m10">
				...
				<c:forEach items="${loanApplySReviewList.items }" var="loan">
					<tr class="info" ondblclick='window.location.href="${pageContext.request.contextPath }/loan/loanApply/enterLoanFinalReviewDetail?id=${loan.id }"'>
						<td>${loan.loanName }</td>
				...
				<tr>
				<td colspan=8><page:Pager formName="loanApplySReviewListForm"
						pageAttributeName="loanApplySReviewList" styleClass="textfield"
