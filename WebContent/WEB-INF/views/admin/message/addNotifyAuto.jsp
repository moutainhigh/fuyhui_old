...
<body>
	...
	<div>
		<form action="${pageContext.request.contextPath }/notifyAuto/add"
			id="addForm" name="addForm" method="post">
			<table class="table table-bordered table-hover definewidth m10">
				<tr>
					<td width="20%" class="tableleft">模板标题：</td>
					<td><input value="" id="name" name="name" type="text" placeholder="请输入模板标题"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea rows="3" cols="20" id="template" name="template" placeholder="请输入内容"></textarea></td>
				</tr>
				<tr>
