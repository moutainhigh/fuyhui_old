...
<body>
	...
	<div>
		<form action="${pageContext.request.contextPath }/admin/member/add"
			id="addForm" name="addForm" method="post" onsubmit="return check();">
			<table class="table table-bordered table-hover definewidth m10">
				<tr>
					<td width="20%" class="tableleft">管理员名称：</td>
					<td><input value="" id="username" name="username" type="text" placeholder="请输入管理员名称"></td>
				</tr>
				<tr>
					<td width="20%" class="tableleft">真实姓名：</td>
					<td><input value="" id="realname" name="realname" type="text" placeholder="请输入真实姓名"></td>
				</tr>
				<tr>
