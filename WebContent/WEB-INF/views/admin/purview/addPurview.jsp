...
<body>
	...
	<div>
		<form action="${pageContext.request.contextPath }/admin/purview/add"
			id="addForm" name="addForm" method="post">
			<table class="table table-bordered table-hover definewidth m10">
				<tr>
					<td width="20%" class="tableleft">权限名称：</td>
					<td><input value="" id="purviewName" name="purviewName" type="text" placeholder="请输入权限名称"></td>
				</tr>
				<tr>
					<td width="20%" class="tableleft">权限标识：</td>
					<td><input value="" id="purviewFlag" name="purviewFlag" type="text" placeholder="请输入权限标识"></td>
				</tr>
				<tr>
					<td width="20%" class="tableleft">描述：</td>
					<td><textarea rows="3" cols="20" id="describ" name="describ" placeholder="请输入描述"></textarea></td>
				</tr>
				<tr>
