...
<body>
	...
	<form id="userAccountListForm" action="${pageContext.request.contextPath }/backAccount/personal/index" class="form-inline definewidth m20" method="post">
		...
		<table class="table table-bordered table-hover definewidth m10">
			<thead>
				<tr>
					...
					<th><span class="badge badge-info"
						style="font-size: 18px; margin-bottom: 10px;">资产总额(元)</span></th>
					<th><span class="badge badge-info"
						style="font-size: 18px; margin-bottom: 10px;">可用余额(元)</span></th>
					<th><span class="badge badge-info"
						style="font-size: 18px; margin-bottom: 10px;">冻结金额(元)</span></th>
					<th><span class="badge badge-info"
						style="font-size: 18px; margin-bottom: 10px;">待收金额(元)</span></th>
				</tr>
			</thead>
			<c:forEach items="${userAccountList.items }" var="userAccount">
				<tr class="info">
					...
					<td>${userAccount.total+userAccount.awaitIncome}</td>
			...
			<tr>
				<td colspan=6><page:Pager formName="userAccountListForm"
