	...
	<div class="warp_account_center">
		...
		<div class="user_account1000">
			...
			<div class="fl account_rightContent_box">
				<div class="acc_rigContent_name" style="height:24px;text-indent:-9999px;">提现</div>
				<!-- 内容盒子Start -->
					...
					<div class="tup_up_area">
						<div id="wit_content">
							...
							<div class="wit_bank_increment" style="padding-top:93px;">
								<p class="fl">银行卡号</p>
								<div class="fl open_accmount">+&nbsp;&nbsp;绑定银行卡</div>
								<div class="clear"></div>
							</div>
							</c:if>	
							<!-- 已开通托管账户时显示此部分内容 -->
							...
							<div class="avyueBox" style="margin-bottom:28px;font-size: 14px;color: #323232;">
								<span style='margin-right: 16px;'>可用余额</span>
								<span class='avumoney' style='color:#ff5353;' ams='${userAccountamt }'>${userAccountamt }</span>
						...
						<div class="bank_comment_box">
							...
							<div class="bank_txtes">
								...
								<p class="bank_txt_item">
									3、提现单笔限额100万，单日提现金额无限制。
								</p>
								<p class="bank_txt_item">
									4、禁止洗钱、信用卡套现、虚假交易等行为，一经发现并确认，将终止该账户的使用。
								</p>
								<p class="bank_txt_item">
									5、如果提现金额没有及时到账，请联系客服：4009-303-606
								</p>
							</div>
						</div>
					</div>
