...
<head lang="zh-cn">
	...
	<script type="text/javascript" src='${pageContext.request.contextPath }/static/scripts/userAccount/traderecord.js'></script>
	<style type="text/css">
		.tradeDivs
		{
			/*width: 162px;*/
	...
	<div class="warp_account_center">
		...
		<div class="user_account1000">
			...
			<div class="fl account_rightContent_box">
				<div class="acc_rigContent_name" style="height:24px;text-indent:-9999px;">交易明细</div>
				<!-- 内容盒子Start -->
				<div class="tra_rigBotContent_box">
					...
					<div class="comtab" style="margin-top:30px;">
						<div class="table_title">
							<!-- <div class="fl tra_num_title tradeDivs">交易编号</div> -->
							<div class="fl tra_accont_title tradeDivs">交易金额</div>
							<div class="fl tra_avial_title tradeDivs">可用余额</div>
							<div class="fl tra_types_title tradeDivs">交易类型</div>
							<div class="fl tra_time_title tradeDivs">交易时间</div>
							<div class="fl tra_time_title tradeDivs">交易备注</div>
							<div class="clear"></div>
						</div>
