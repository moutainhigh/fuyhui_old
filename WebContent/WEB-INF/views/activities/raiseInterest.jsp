...
<head lang="zh-cn">
    ...
    <style type="text/css">
		.reg_redpacket_wrap
		{
			width: 100%;
			height: 700px;
			background: url(../../static/images/activities/raise.png) no-repeat center;
		}
		.newWel_contents
		{
			width: 100%;
			height: 700px;
			background: url(../../static/images/activities/raise2.png) no-repeat center;
		}
    </style>
