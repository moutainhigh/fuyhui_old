...
<head lang="zh-cn">
	...
	<script type="text/javascript" src='${pageContext.request.contextPath }/static/scripts/borrowerCenter/borrowtrade.js'></script>
	<style type="text/css">
		.tradeDivs
		{
			/*width: 162px;*/
	...
	<div class="warp_account_center">
		...
		<div class="user_account1000">
			...
			<div class="fl account_rightContent_box">
				<div class="acc_rigContent_name" style="height:26px;text-indent:-9999px;">交易明细</div>
				<!-- 内容盒子Start -->
