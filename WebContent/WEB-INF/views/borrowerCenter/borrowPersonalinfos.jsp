...
<body>
	...
	<div class="warp_account_center">
		...
		<div class="user_account1000">
			...
			<div class="fl account_rightContent_box">
				<div class="acc_rigContent_name" style="height:26px;text-indent:-9999px;">安全信息</div>
				<!-- 内容盒子Start -->
				<div class="per_rigBotContent_box" style="position:relative;">
					...
					<div class="accountInfos">
						...
						<div class="com_perDiv per_cerIdBox">
							...
							<p class="com_perTitle" style="width:112px;margin-right:96px;">法人代表身份证号</p>
						...
						<div class="com_perDiv per_certificationBox">
							<div class="fl com_perBgBox"><p class="certificationBg"></p></div>
							<p class="com_perTitle" style="width:112px;margin-right:96px;">法人代表真实姓名</p>
							<p class="com_perTxt realNamesTxt"> ${sessionScope.user_inf.realname}</p>
							<!-- 温馨提示：当状态为‘未设置’时，此处的样式是per_error_tips；
								 当状态为‘已设置’时，此处的样式是per_success_tips
							 -->
						...
						<form action="${pageContext.request.contextPath }/fy/pwdMgt" id="addForm" name="addForm" method="post" > 
							<div class="com_perDiv tradePwdBox">
								...
								<p class="com_perTxt txmaTxt">第三方支付托管平台提现密码</p>
								<!-- 温馨提示：当状态为‘未设置’时，此处的样式是per_error_tips；
									 当状态为‘已设置’时，此处的样式是per_success_tips
								 -->
								<p class="com_perTips tmimg per_error_tips"></p>
								<!-- <p class="com_perState tradePwdState">未设置</p> -->
								<!-- <p class="com_perSite tradePwdSite">未设置</p> -->
								<button type="submit" id="submit_btn" class="com_perSite txSite fl" style="border:0;background:#fff;margin-left:-19px;">修改</button>
								<div class="clear"></div>
							</div>
						</form>
	...
	<div class="com_window iphones_window">
		<div class="com_wTitle" style="margin-bottom:36px;">
			...
			<p class="fr com_window_close head_wClose iphone_wClose"></p>
			<div class="clear"></div>
		</div>
		<!-- 验证身份start -->
		<div class="site01Box">
		...
		<div class="site02Box" style="display:none;">
			<form action="${pageContext.request.contextPath }/fy/chgMobile" id="addForm" name="addForm" method="post" target="_blank">
	...
	<div class="com_window email_window">
		<div class="com_wTitle" style="margin-bottom:30px;">
			...
			<p class="fr com_window_close head_wClose email_close"></p>
			<div class="clear"></div>
		</div>
		<div class="com_wInput">
