...
<head lang="zh-cn">
    ...
    <script type="text/javascript" src='${pageContext.request.contextPath }/static/scripts/institutionsCenter/guaranteeDetail.js'></script>
</head>
<body>
	<!-- 公共头部Start -->
				...
				<div class="gurDetail_box">
					<div class="gur_borrow_infos">
						...
						<div class="gur_divs">
							...
							<p class="fl gur_detailp02">借款利率：<span class='bor_rate'>10%</span></p>
							<p class="fl">身份证号：<span class='bor_ID'>410000000000000000</span></p>
							<div class="clear"></div>
						</div>
						<div class="gur_divs">
							<p class="fl gur_detailp01">借款金额：<span class='bor_money'>2000</span>元</p>
							<p class="fl gur_detailp02">借款用途：<span class='bor_use'>经营金周转</span></p>
							<p class="fl">手机号码：<span class='bor_iphone'>15812345678</span></p>
							<div class="clear"></div>
						</div>
						<div class="gur_divs">
							<p class="fl gur_detailp01">贷款期限：<span class='bor_month'>6</span>个月</p>
