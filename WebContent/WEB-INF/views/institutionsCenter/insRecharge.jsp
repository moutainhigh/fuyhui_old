	...
	<div class="warp_account_center">
		...
		<div class="user_account1000">
			...
			<div class="fl account_rightContent_box">
				<div class="acc_rigContent_name">充值</div>
				<!-- 内容盒子Start -->
				<div class="rech_rigBotContent_box">
					...
					<div class="tup_up_area">
						...
						<form action="<%=request.getContextPath() %>/account/webRecharge1" method="post" target='_blank;'>
							<div id="eb_content">
								...
								<div class="ebank_middle">
									...
									<div class="fl ebbot_infos entriseBox">
										...
										<span class='ebhand_cost' ebinterestRate=${interestRate}>0</span>
								...
								<div class="bankBox_wrap">
									...
									<div class="enterprise_bankBox">
										<div class="enter_titles">
											...
											<span class='bankBox_last'>（企业网银充值手续费10元/笔，适用于大额充值。）</span>
										</div>
									...
									<div class="person_bankBox" style="display:none">
										...
										<div class="enter_titles">
											...
											<span class='bankBox_last'>（个人网银充值手续费X%。，适用于小额充值。）</span>
										</div>
										<div class="bankBox_list">
											<ul class="bankBox_ul">
												<!-- 中国工商银行-->
							...
							<div class="bank_comment_box">
								...
								<div class="bank_txtes">
									...
									<p class="bank_txt_item">
										5、如遇充值后银行已扣款，网站个人账户可用余额未增加，请及时联系客服：4008-0000-000。 
									</p>
								</div>
							</div>
	...
	$(function(){
	    ...
	    if(ebfee_type==1){
	        $('#ebtop_up_amount').keyup(function(){
	            $('.ebhand_cost').html(($(this).val()*ebhand_rate).toFixed(2));
	        });
	    ...
	    if(ebfee_type1==1){
	        $('#ebtop_up_amount').keyup(function(){
	            $('.ebhand_cost02').html(($(this).val()*ebhand_rate1).toFixed(2));
	        });
