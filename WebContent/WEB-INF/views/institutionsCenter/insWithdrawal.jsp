	...
	<div class="warp_account_center">
		...
		<div class="user_account1000">
			...
			<div class="fl account_rightContent_box">
				<div class="acc_rigContent_name">提现</div>
				<!-- 内容盒子Start -->
				<div class="wit_rigBotContent_box">
					<div class="tup_up_area">
						<div id="wit_content">
                          ...
                          <form action="${pageContext.request.contextPath }/account/withdrawal" method="post" target="_blank;">
							<div class="witbind_bank_box">
								...
								<div class="relbind_bank_middle">
									<span>到账金额</span>
									<span class='bank_balance'>0.00</span>
						...
						<div class="bank_comment_box">
							...
							<div class="bank_txtes">
								<p class="bank_txt_item">
									1.完成身份认证、设置交易码、绑定银行卡（借记卡），才能进行提现操作。
								</p>
								<p class="bank_txt_item">
									2.单笔提现最高金额为xx万元，单账户每天最高可以提现xx万元。
								</p>
								<p class="bank_txt_item">
									3.平台目前支持T+1到账，即当天提现下一工作日到账；如遇法定节假日需顺延到下一工作日。由此造成的不便，请多多谅解。
								</p>
								<p class="bank_txt_item">
									4.第三方支付平台提现服务时间为早上7:00-晚上22:00。
								</p>
								<p class="bank_txt_item">
									5.禁止洗钱、虚假交易等行为，一经发现并确认，平台有权利冻结该账户。
								</p>
							</div>
						</div>
					</div>
	...
	$(function(){
	    ...
	    if(ebfee_type==1){
	        $('#withdrawal_amount').keyup(function(){
	            $('.wit_cost').html(($(this).val()*ebhand_rate).toFixed(2));
	            // 到账金额计算
			    var txmoney = $('.withdrawal_amount').val();
			    var handmoney = $('.wit_cost').html();
			    $('.bank_balance').html(txmoney - handmoney);
	        });
